...
```
Progress: [■■■■■■■░░░░░░░░░░░░░] 39.7% Completed (119 / 300+ Problems Solved)
```

| Metric | Details |
| :--- | :--- |
| **Total Problems Solved** | **119** / 300+ |
| **C++ Implementations** | **119** |
...
| :-: | :--- | :--- | :-: | :-: | :---: |
| 01 | **Arrays** | [`/01-Arrays`](./01-Arrays/) | 31 | 30 | 🟢 Completed |
| 02 | **Binary Search** | [`/02-Binary-Search`](./02-Binary-Search/) | 14 | 25 | 🟡 In Progress |
| 03 | **Strings** | [`/03-Strings`](./03-Strings/) | 26 | 30 | 🟡 In Progress |
...
| 07 | **Linked List** | [`/07-Linked-List`](./07-Linked-List/) | 3 | 25 | 🟡 In Progress |
...
| 17 | **Bit Manipulation** | [`/17-Bit-Manipulation`](./17-Bit-Manipulation/) | 1 | 15 | 🟡 In Progress |
